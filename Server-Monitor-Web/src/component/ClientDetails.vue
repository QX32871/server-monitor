  ...
  <el-scrollbar>
    <div class="client-details" v-loading="Object.keys(details.base).length === 0">
      <div v-if="Object.keys(details.base).length">
        ...
        <div style="min-height: 200px" v-if="details.base.online" v-loading="!details.runtime.list.length">
          <!--list不为空才显示-->
          <div style="display: flex" v-if="details.runtime.list.length">
            <el-progress type="dashboard" :width="100" :percentage="now.cpuUsage * 100"
              ...
              <div style="font-size: 13px;color: rgb(128, 128, 128);margin-top: 5px">{{
            ...
            <el-progress style="margin-left: 20px"
              ...
              <div style="font-size: 13px;color: rgb(128, 128, 128);margin-top: 5px">{{ (now.memoryUsage).toFixed(1) }}
                GB
              </div>
            </el-progress>

...
import com.qx32871.entity.vo.response.AuthorizeVO;
import com.qx32871.filter.JwtAuthenticationFilter;
import com.qx32871.filter.RequestLogFilter;
...
public class SecurityConfiguration {
    ...
    private void handleProcess(HttpServletRequest request,
        ...
        if (exceptionOrAuthentication instanceof AccessDeniedException exception) {
            ...
            String jwt = utils.createJwt(user, accountDTO.getUsername(), accountDTO.getId());
            if (jwt == null) {
                writer.write(RestBean.forbidden("登录验证频繁，请稍后再试").asJsonString());
            } else {
                AuthorizeVO vo = accountDTO.asViewObject(AuthorizeVO.class, o -> o.setToken(jwt));
